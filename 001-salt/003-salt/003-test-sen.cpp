...
int main() {
    ...
    std::string salt1 = "s1gdfgdfgdfgdfgd";
    std::string salt2 = "s2gdfgdfgdfgdfgd";
    std::string salt = salt1+salt2;
    ...
    while (1) {
        ...
        if (uBit.buttonA.isPressed()) {
            ...
            std::string originalText = header + salt;
        ...
        if (uBit.buttonB.isPressed()) {
            ...
            std::string originalText = header + salt1;
            std::string originalTexts2 = header + salt2;
            std::string encryptedText = encrypt(originalText, key, iv);
            std::string encryptedTexts2 = encrypt(originalTexts2, key, iv);
